...
const Education = () => {
  return (
    <div id="education" className="p-10 lg:px-24 h-screen items-center max-w-screen " style={{ backgroundImage: "url('/images/tutorial.jpg')" }}>
      <div className="flex justify-center group gap-4" data-aos="fade-up">
